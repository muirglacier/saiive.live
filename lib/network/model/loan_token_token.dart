class LoanTokenToken {
  ...
  factory LoanTokenToken.fromJson(Map<String, dynamic> json) {
    return LoanTokenToken(
      symbol: json['symbol'],
  ...
  factory LoanTokenToken.fromJsonEntry(Map<String, dynamic> json) {
    return LoanTokenToken(
      symbol: json['symbol'],
      symbolKey: json['symbolKey'],
      id: json["id"],
