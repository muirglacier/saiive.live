            ...
            child: Column(children: [Card(child: Padding(padding: EdgeInsets.all(30), child: Column(children: <Widget>[
              ...
              Container(
                child: Row(children: [
                  ...
                  Expanded(flex: 6, child: Text((widget.liquidity.poolSharePercentage / 100 * widget.liquidity.poolPair.reserveA).toStringAsFixed(8), textAlign: TextAlign.right))
                ]),
              ),
              Container(
                child: Row(children: [
                  Expanded(flex: 4, child: Text(widget.liquidity.tokenB)),
                  Expanded(flex: 6, child: Text((widget.liquidity.poolSharePercentage / 100 * widget.liquidity.poolPair.reserveB).toStringAsFixed(8), textAlign: TextAlign.right))
                ]),
              ),
              Container(
                  child: Row(children: [
