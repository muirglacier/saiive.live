        ...
        child: Column(children: [
          Row(children: <Widget>[
            Container(
                ...
                child: TokenIcon(widget.batch.loan.symbol)),
            Container(width: 10),
            Expanded(
                child: Column(
                  ...
                  Text(
                    "Batch: " +
                        widget.batch.index.toString() +
                        " - " +
                        widget.batch.loan.name,
          ...
          Table(border: TableBorder(), children: [
            TableRow(children: [
              ...
              Text('Highest bid', style: Theme.of(context).textTheme.caption)
            ]),
          ]),
          Container(height: 10),
          Table(border: TableBorder(), children: [
            TableRow(children: [
              Text(FundFormatter.format(widget.batch.collateralValueUSD,
                      fractions: 2) +
                  ' \$'),
              Text(widget.batch.highestBid != null
                  ? FundFormatter.format(
                          widget.batch.highestBid.amount.valueUSD,
                          fractions: 2) +
                      ' \$'
                  : 'N/A')
            ])
          ...
          Table(border: TableBorder(), children: [
            TableRow(children: [
              Text(FundFormatter.format(widget.batch.loan.valueUSD,
                      fractions: 2) +
                  ' \$'),
              Text(FundFormatter.format(widget.batch.loan.valueUSD * 1.05,
                      fractions: 2) +
                  ' \$'),
            ]),
          ])
